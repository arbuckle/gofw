...
// Getters and setters for Response.Data map.  Must decide whether it's better to
// access Data via these methods, or directly.
func (response *Response) make() {
	response.Data = make(map[string]interface{})
}
func (response *Response) Get(key string) interface{} {
	return response.Data[key]
}
func (response *Response) Set(key string, value interface{}) {
